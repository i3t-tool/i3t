...
//  ImGuiPlatformIO interface. 2020-07-10: OpenGL: Added support for glad2
//  OpenGL loader. 2020-05-08: OpenGL: Made default GLSL version 150 (instead of
//  130) on OSX. 2020-04-21: OpenGL: Fixed handling of
//  glClipControl(GL_UPPER_LEFT) by inverting projection matrix. 2020-04-12:
//  OpenGL: Fixed context version check mistakenly testing for 4.0+ instead
//  of 3.2+ to enable ImGuiBackendFlags_RendererHasVtxOffset. 2020-03-24:
//  OpenGL: Added support for glbinding 2.x OpenGL loader. 2020-01-07: OpenGL:
//  Added support for glbinding 3.x OpenGL loader. 2019-10-25: OpenGL: Using a
//  combination of GL define and runtime GL version to decide whether to use
...
//  can override the GLSL version e.g.
//  "#version 150". 2018-02-23: OpenGL: Create the VAO in the render function so
//  the setup can more easily be used with multiple shared GL context.
//  2018-02-16: Misc: Obsoleted the io.RenderDrawListsFn callback and exposed
//  ImGui_ImplSdlGL3_RenderDrawData() in the .h file so you can call it
//  yourself. 2018-01-07: OpenGL: Changed GLSL shader version from 330 to 150.
//  2017-09-01: OpenGL: Save and restore current bound sampler. Save and restore
//  current polygon mode. 2017-05-01: OpenGL: Fixed save and restore of current
//  blend func state. 2017-05-01: OpenGL: Fixed save and restore of current
//  GL_ACTIVE_TEXTURE. 2016-09-05: OpenGL: Fixed save and restore of current
//  scissor rectangle. 2016-07-29: OpenGL: Explicitly setting
//  GL_UNPACK_ROW_LENGTH to reduce issues because SDL changes it.
//  (#752)
...
#endif
	io.BackendFlags |= ImGuiBackendFlags_RendererHasViewports; // We can create multi-viewports
