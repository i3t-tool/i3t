...
public:
    ...
    WorkspaceMatrixTranslation(ImTextureID headerBackground, Ptr<Core::NodeBase> nodebase = Builder::createTransform<Core::Translation>(), std::string headerLabel = "Translation", std::string nodeLabel = "Translation");
