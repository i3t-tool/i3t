...
public:
    ...
    WorkspaceMatrix4x4(ImTextureID headerBackground, Ptr<Core::NodeBase> nodebase = Builder::createNode<ENodeType::Matrix>(), std::string headerLabel = "Matrix4x4", std::string nodeLabel = "Matrix4x4");
