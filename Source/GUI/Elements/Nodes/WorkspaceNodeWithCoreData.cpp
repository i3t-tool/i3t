...
WorkspaceNodeWithCoreData::WorkspaceNodeWithCoreData(std::unique_ptr<Core::NodeBase> nodebase, ImTextureID headerBackground, std::string headerLabel = "default CoreData-node header") /* \todo JH take default label from Const.h*/
