...
/* Order of inheritance is important! WorkspaceNodeBaseData has to be first because it is necessary first create NodeBase to read data from it */
class WorkspaceNormalizeVector :
