...
//		//: WorkspaceMatrix4x4(Core::Builder::createNode<ENodeType::TrackBall>()) /* \todo JH trackball not exist */
...
////				drawDragFloatWithMap_Inline(valueChanged, localData, coreMap[columns * 4 + rows], fmt::format("##{}:r{}c{}", idOfNode, rows, columns));
////
////				if(columns != 3)
////				{
////					ImGui::SameLine();
...
//			{
//				localData = coreData[columns][rows]; /* Data are column-wise */
//				drawDragFloatWithMap_Inline(diwne, getNumberOfVisibleDecimal(), valueChanged, localData, coreMap[columns * 4 + rows], fmt::format("##{}:r{}c{}", getId(), rows, columns));
//
//				if(columns != 3)
//				{
//					ImGui::SameLine();
