...
namespace SystemDialogs
{
   ...
   */
  bool OpenSingleFileDialog(std::string& result, const std::string& title, const std::string& root = "", const std::vector<std::string>& filter = { "All Files", "*" });
   ...
   * \return Whether file was selected or not.
   */
  bool SaveSingleFileDialog(std::string& filename, const std::string& title, const std::string& root = "", const std::vector<std::string>& filter = { "All Files", "*" });
