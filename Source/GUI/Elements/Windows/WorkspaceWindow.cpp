...
{
	ImGui::Begin(getName("Workspace").c_str(), getShowPtr(), g_WindowFlags | ImGuiWindowFlags_MenuBar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse);
...
void WorkspaceWindow::checkQueryContextMenus()
{
	...
	if (ImGui::BeginPopup("Node Context Menu") && !(ImGui::BeginPopup("float_context_menu")))
	{
		...
		if (ImGui::MenuItem("Delete")) { ne::DeleteNode(context_node->getId()); }
		ImGui::EndPopup();
	}
