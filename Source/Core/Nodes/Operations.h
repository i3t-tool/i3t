...
struct Operation
{
	...
	const int
	    numberOfOutputs; ///< \todo MH Remove, size is known at compile time.
	...
	const bool isConstructor =
	    false; //< this is a standard operator node - processes only the connected
	 ...
	 * enum class ENodeType \param defaultLabel default string label in the
	 * workspace \todo Q which one is used - this or the label from
	 */
	Operation(const std::string& keyWord, const std::string& defaultLabel)
	    : keyWord(keyWord), defaultLabel(defaultLabel), numberOfInputs(0),
	      numberOfOutputs(0)
	{
	}
	 ...
	 * operations) \param keyWord enum defined in enum class ENodeType \param
	 ...
	 */
	Operation(const std::string& keyWord, const std::string& defaultLabel,
	          const int numberOfInputs, const std::vector<EValueType>& inputTypes,
	          const int numberOfOutputs,
	          const std::vector<EValueType>& outputTypes)
	    : keyWord(keyWord), defaultLabel(defaultLabel),
	 ...
	 */
	Operation(const std::string& keyWord, const std::string& defaultLabel,
	          bool isConstructor, int numberOfInputs,
	          const std::vector<EValueType>& inputTypes,
	          const int numberOfOutputs,
	          const std::vector<EValueType>& outputTypes)
	    : keyWord(keyWord), defaultLabel(defaultLabel),
	      isConstructor(isConstructor), numberOfInputs(numberOfInputs),
	      inputTypes(inputTypes), numberOfOutputs(numberOfOutputs),
	...
	Operation(const std::string& keyWord, const std::string& defaultLabel,
	          ...
	          const int numberOfOutputs,
	          const std::vector<EValueType>& outputTypes,
	          const std::string& defaultTagText,
	          const std::vector<std::string>& defaultInputNames)
	    : keyWord(keyWord), defaultLabel(defaultLabel),
	      numberOfInputs(numberOfInputs), inputTypes(inputTypes),
	      numberOfOutputs(numberOfOutputs), outputTypes(outputTypes),
	      defaultTagText(defaultTagText), defaultInputNames(defaultInputNames)
	{
	}
	/**
	...
	Operation(const std::string& keyWord, const std::string& defaultLabel,
	    ...
	    : keyWord(keyWord), defaultLabel(defaultLabel),
	      ...
	      numberOfOutputs(numberOfOutputs), outputTypes(outputTypes),
	      defaultTagText(defaultTagText), defaultInputNames(defaultInputNames),
	      defaultOutputNames(defaultOutputNames)
	{
	}
...
static const std::vector<EValueType> twoMatrixInput = {EValueType::Matrix,
                                                       EValueType::Matrix};
static const std::vector<EValueType> twoVectorInput = {EValueType::Vec4,
                                                       EValueType::Vec4};
static const std::vector<EValueType> twoVector3Input = {EValueType::Vec3,
                                                        EValueType::Vec3};
static const std::vector<EValueType> twoFloatInput = {EValueType::Float,
                                                      EValueType::Float};
static const std::vector<EValueType> twoQuatInput = {EValueType::Quat,
                                                     EValueType::Quat};

static const std::vector<EValueType> threeVector3Input = {
    EValueType::Vec3, EValueType::Vec3, EValueType::Vec3};
static const std::vector<EValueType> threeFloatInput = {
    EValueType::Float, EValueType::Float, EValueType::Float};

static const std::vector<EValueType> fourVectorInput = {
    EValueType::Vec4, EValueType::Vec4, EValueType::Vec4, EValueType::Vec4};
static const std::vector<EValueType> fourVector3Input = {
    EValueType::Vec3, EValueType::Vec3, EValueType::Vec3, EValueType::Vec3};
static const std::vector<EValueType> fourFloatInput = {
    EValueType::Float, EValueType::Float, EValueType::Float, EValueType::Float};

static const std::vector<EValueType> sixFloatInput = {
    EValueType::Float, EValueType::Float, EValueType::Float,
    EValueType::Float, EValueType::Float, EValueType::Float};
...
static const std::vector<EValueType> twoVectorFloatInput = {
    EValueType::Vec4, EValueType::Vec4, EValueType::Float};
static const std::vector<EValueType> twoVector3FloatInput = {
    EValueType::Vec3, EValueType::Vec3, EValueType::Float};
static const std::vector<EValueType> twoFloatVector3Input = {
    EValueType::Float, EValueType::Float, EValueType::Vec3};
static const std::vector<EValueType> twoQuatFloatInput = {
    EValueType::Quat, EValueType::Quat, EValueType::Float};

static const std::vector<EValueType> matrixVectorInput = {EValueType::Matrix,
                                                          EValueType::Vec4};
static const std::vector<EValueType> vectorMatrixInput = {EValueType::Vec4,
                                                          EValueType::Matrix};
static const std::vector<EValueType> vector3FloatInput = {EValueType::Vec3,
                                                          EValueType::Float};
static const std::vector<EValueType> floatMatrixInput = {EValueType::Float,
                                                         EValueType::Matrix};
static const std::vector<EValueType> floatVectorInput = {
    EValueType::Float, EValueType::Vec4}; // PF: vec3 changed to vec4
static const std::vector<EValueType> floatVector3Input = {EValueType::Float,
                                                          EValueType::Vec3};
static const std::vector<EValueType> floatQuatInput = {EValueType::Float,
                                                       EValueType::Quat};
static const std::vector<EValueType> quatVector3Input = {EValueType::Quat,
                                                         EValueType::Vec3};

static const std::vector<EValueType> matrixMulAndMatrixInput = {
    EValueType::MatrixMul, EValueType::Matrix};
...
static const std::vector<std::string> AngleAxisToQuatInputNames = {
    "angle", "angle / 2", "vec3"};
static const std::vector<std::string> QuatToFloatVecInputNames = {"w",
                                                                  "(x,y,z)"};
static const std::vector<std::string> AngleAxisInputNames = {"angle", "axis"};
static const std::vector<std::string> Vectors3ToMatrixInputNames = {
    "vec3 X", "vec3 Y", "vec3 Z", "vec3 T"};
static const std::vector<std::string> VectorsToMatrixInputNames = {
    "vec4 X", "vec4 Y", "vec4 Z", "vec4 T"};
static const std::vector<std::string> ClampFloatInputNames = {"val", "min",
                                                              "max"};
...
static const std::vector<std::string> orthoFrustrumInputNames = {
    "left", "right", "bottom", "top", "near", "far"};
static const std::vector<std::string> PerspectiveInputNames = {"fovy", "aspect",
                                                               "near", "far"};
static const std::vector<std::string> lookAtInputNames = {"eye", "center",
                                                          "up"};
...
static const std::vector<Operation> operations = {
    {n(ENodeType::Inversion), "inversion", 1, matrixInput, 1,
     matrixInput}, // inversion
    {n(ENodeType::Transpose), "transpose", 1, matrixInput, 1,
     matrixInput}, // transpose
    {n(ENodeType::Determinant), "determinant", 1, matrixInput, 1,
     floatInput}, // determinant
    {n(ENodeType::MatrixMulMatrix), "mat * mat", 2, twoMatrixInput, 1,
     matrixInput}, // mat * mat
    {n(ENodeType::MatrixAddMatrix), "mat + mat", 2, twoMatrixInput, 1,
     matrixInput}, // mat + mat
    {n(ENodeType::MatrixMulVector), "mat * vec4", 2, matrixVectorInput, 1,
    ...
    {n(ENodeType::MatrixMulFloat), "float * mat", 2, floatMatrixInput, 1,
     matrixInput}, // float * mat
    {n(ENodeType::VectorDotVector), "vec4 . vec4", 2, twoVectorInput, 1,
     floatInput}, // vec4 . vec4
    {n(ENodeType::VectorAddVector), "vec4 + vec4", 2, twoVectorInput, 1,
     vectorInput}, // vec4 + vec4
    {n(ENodeType::VectorSubVector), "vec4 - vec4", 2, twoVectorInput, 1,
     vectorInput}, // vec4 - vec4
    {n(ENodeType::VectorMulFloat), "float * vec4", 2, floatVectorInput, 1,
     vectorInput}, // float * vec4
    {n(ENodeType::VectorPerspectiveDivision), "perspective division", 1,
     vectorInput, 1, vectorInput}, // perspective division
    {n(ENodeType::NormalizeVector), "normalize vec4", 1, vectorInput, 1,
     vectorInput}, // normalize vec4
    {n(ENodeType::MixVector), "mix vec4", 3, twoVectorFloatInput, 1,
     vectorInput, NO_TAG, mixInputNames}, // mix vec4
    {n(ENodeType::Vector3CrossVector3), "vec3 x vec3", 2, twoVector3Input, 1,
     vector3Input}, // vec3 x vec3
    {n(ENodeType::Vector3DotVector3), "vec3 . vec3", 2, twoVector3Input, 1,
     floatInput}, // vec3 . vec3
    {n(ENodeType::Vector3AddVector3), "vec3 + vec3", 2, twoVector3Input, 1,
    ...
    {n(ENodeType::ShowVector3), "show vec3", 1, vector3Input, 1, matrixInput,
     ...
     "vectors."}, // show vec3
    {n(ENodeType::MixVector3), "mix vec3", 3, twoVector3FloatInput, 1,
     vector3Input, NO_TAG, mixInputNames}, // mix vec3
    {n(ENodeType::ConjQuat), "quat conjugate", 1, quatInput, 1,
     quatInput}, // quat conjugate
    {n(ENodeType::FloatVecToQuat), "quatfloat, vec3", 2, floatVector3Input, 1,
     quatInput}, // quatfloat, vec3
    {n(ENodeType::AngleAxisToQuat), "quatangle, axis", 3, twoFloatVector3Input,
     1, quatInput, NO_TAG, AngleAxisToQuatInputNames}, // quatangle, axis
    {n(ENodeType::VecVecToQuat), "quatvec3, vec3", 2, twoVector3Input, 1,
     quatInput,
     "Input vector's are normalized."}, // quatvec3, vec3   //PF: floatInput
                                        // changed to quatInput
    {n(ENodeType::QuatToFloatVec), "quat -> float, vec3", 1, quatInput, 2,
     floatVector3Input, NO_TAG, DEFAULT_NAMES,
     QuatToFloatVecInputNames}, // quat -> float, vec3
    {n(ENodeType::QuatToAngleAxis), "quat -> angle, axis", 1, quatInput, 2,
     floatVector3Input, NO_TAG, DEFAULT_NAMES,
     AngleAxisInputNames}, // quat -> angle, axis
    {n(ENodeType::QuatToEuler), "quat -> euler", 1, quatInput, 3,
     threeFloatInput}, // quat -> euler
    {n(ENodeType::EulerToQuat),
     ...
     {"x", "y", "z"}}, // euler ->
                       // quat
    {n(ENodeType::QuatInverse), "inverse quat", 1, quatInput, 1,
     quatInput}, // inverse quat
    {n(ENodeType::QuatSlerp), "quat slerp", 3, twoQuatFloatInput, 1,
     quatInput}, // quat slerp
    {n(ENodeType::QuatLongWaySlerp), "quat long way slerp", 3,
     twoQuatFloatInput, 1, quatInput}, // quat long way slerp
    {n(ENodeType::QuatLerp), "quat lerp", 3, twoQuatFloatInput, 1,
     quatInput}, // quat lerp
    {n(ENodeType::FloatMulQuat), "float * quat", 2, floatQuatInput, 1,
     quatInput}, // float * quat
    {n(ENodeType::QuatMulQuat), "quat * quat", 2, twoQuatInput, 1,
     quatInput}, // quat * quat
    {n(ENodeType::QuatVecConjQuat), "qvq*", 2, quatVector3Input, 1,
     vector3Input}, // qvq*
    ...
    {n(ENodeType::ClampFloat), "clamp float", 3, threeFloatInput, 1, floatInput,
     ...
     ClampFloatInputNames}, // clamp float
    {n(ENodeType::FloatMulFloat), "float * float", 2, twoFloatInput, 1,
     floatInput}, // float * float
    {n(ENodeType::FloatDivFloat), "float / float", 2, twoFloatInput, 1,
     floatInput}, // float / float
    {n(ENodeType::FloatAddFloat), "float + float", 2, twoFloatInput, 1,
     floatInput}, // float + float
    {n(ENodeType::FloatPowFloat), "float ^ float", 2, twoFloatInput, 1,
     floatInput}, // float ^ float
    {n(ENodeType::MixFloat), "mix float", 3, threeFloatInput, 1, floatInput,
     NO_TAG, mixInputNames}, // mix float
    {n(ENodeType::FloatSinCos), "sin & cos(float)", 1, floatInput, 2,
     twoFloatInput}, // sin&cos(float)
    ...
    {n(ENodeType::VectorsToMatrix), "vecs4 -> mat", 4, fourVectorInput, 1,
     matrixInput, NO_TAG, VectorsToMatrixInputNames}, // vecs4 -> mat
    {n(ENodeType::MatrixToFloats), "mat -> floats", 1, matrixInput, 16,
     sixteenFloatInput, NO_TAG, DEFAULT_NAMES,
     matrixIndexNames()}, // mat -> floats
    {n(ENodeType::FloatsToMatrix), "floats -> mat", 16, sixteenFloatInput, 1,
     matrixInput, NO_TAG, matrixIndexNames()}, // floats -> mat
    {n(ENodeType::MatrixToTR), "mat -> TR", 1, matrixInput, 2, twoMatrixInput,
     NO_TAG, DEFAULT_NAMES, tr}, // mat -> TR
    {n(ENodeType::TRToMatrix), "TR -> mat", 2, twoMatrixInput, 1, matrixInput,
     NO_TAG, tr}, // TR -> mat
    {n(ENodeType::MatrixToQuat), "mat -> quat", 1, matrixInput, 1,
     quatInput}, // mat -> quat
    {n(ENodeType::QuatToMatrix), "quat -> mat", 1, quatInput, 1,
     matrixInput}, // quat -> mat
    {n(ENodeType::VectorToFloats), "vec4 -> floats", 1, vectorInput, 4,
     fourFloatInput, NO_TAG, DEFAULT_NAMES, xyzw}, // vec4 -> float
    {n(ENodeType::FloatsToVector), "floats -> vec4", 4, fourFloatInput, 1,
     vectorInput, NO_TAG, xyzw}, // floats -> vec4
    {n(ENodeType::Vector3ToFloats), "vec3 -> floats", 1, vector3Input, 3,
     threeFloatInput, NO_TAG, DEFAULT_NAMES, xyz}, // vec3 -> floats
    {n(ENodeType::FloatsToVector3), "floats -> vec3", 3, threeFloatInput, 1,
     vector3Input, NO_TAG, xyz}, // floats -> vec3
    {n(ENodeType::VectorToVector3), "vec4 -> vec3", 1, vectorInput, 1,
     vector3Input}, // vec4 -> vec3
    //
    {n(ENodeType::Vector3ToVector), "vec3 -> vec4", 2, vector3FloatInput, 1,
     vectorInput}, // vec3 -> vec4
    {n(ENodeType::QuatToFloats), "quat -> floats", 1, quatInput, 4,
     fourFloatInput, NO_TAG, DEFAULT_NAMES, xyzw}, // quat -> floats
    {n(ENodeType::FloatsToQuat), "floats -> quat", 4, fourFloatInput, 1,
     quatInput, NO_TAG, xyzw}, // floats -> quat
    {n(ENodeType::NormalizeQuat), "normalize quat", 1, quatInput, 1,
     quatInput}, // normalize quat

    // Value nodes.
    {n(ENodeType::FloatToFloat), "float", true, 1, floatInput, 1, floatInput},
    {n(ENodeType::Vector3ToVector3), "vec3", true, 1, vector3Input, 1,
     vector3Input},
    {n(ENodeType::Vector4ToVector4), "vec4", true, 1, vectorInput, 1,
     vectorInput},
    {n(ENodeType::MatrixToMatrix), "mat", true, 1, matrixInput, 1, matrixInput},
    {n(ENodeType::QuatToQuat),
     "quat",
     true,
     1,
     {EValueType::Quat},
    ...
    {n(ENodeType::MakeEulerX), "eulerAngleX", 1, floatInput, 1, matrixInput,
     NO_TAG, eulerInputNames}, // eulerAngleX
    {n(ENodeType::MakeEulerY), "eulerAngleY", 1, floatInput, 1, matrixInput,
     NO_TAG, eulerInputNames}, // eulerAngleY
    {n(ENodeType::MakeEulerZ), "eulerAngleZ", 1, floatInput, 1, matrixInput,
     NO_TAG, eulerInputNames}, // eulerAngleZ
    {n(ENodeType::MakeScale), "scale", 1, vector3Input, 1,
     matrixInput}, // scale
    {n(ENodeType::MakeAxisAngle), "rotate", 2, floatVector3Input, 1,
     matrixInput, NO_TAG, AngleAxisInputNames}, // rotate
    {n(ENodeType::MakeOrtho), "ortho", 6, sixFloatInput, 1, matrixInput, NO_TAG,
     orthoFrustrumInputNames}, // ortho
    {n(ENodeType::MakePerspective), "perspective", 4, fourFloatInput, 1,
     matrixInput, NO_TAG, PerspectiveInputNames}, // perspective
    {n(ENodeType::MakeFrustum), "frustum", 6, sixFloatInput, 1, matrixInput,
     NO_TAG, orthoFrustrumInputNames}, // frustrum
    {n(ENodeType::MakeLookAt), "lookAt", 3, threeVector3Input, 1, matrixInput,
     NO_TAG, lookAtInputNames}, // lookAt
...
inline const Operation g_sequence = {
    ...
    "seq",
    2,
    matrixMulAndMatrixInput,
    3,
    {EValueType::MatrixMul, EValueType::Matrix, EValueType::Matrix}};
...
FORCE_INLINE const TransformOperation&
getTransformOperation(ETransformType type)
{
...
getTransformDefaults(const std::string& keyWord)
{
