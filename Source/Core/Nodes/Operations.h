...
static const std::vector<Operation> operations = {
    ...
    {"MakeAxisAngle", "rotate constructor", 2, floatVector3Input, 1, matrixInput, NO_TAG, AngleAxisInputNames},       // rotate
    {"MakeOrtho", "ortho constructor", 6, sixFloatInput, 1, matrixInput, NO_TAG, orthoFrustrumInputNames},            // ortho
    {"MakePerspective", "perspective constructor", 4, fourFloatInput, 1, matrixInput, NO_TAG, PerspectiveInputNamas}, // perspective
    {"MakeFrustum", "frustum constructor", 6, sixFloatInput, 1, matrixInput, NO_TAG, orthoFrustrumInputNames},        // frustrum
...
static const std::vector<Operation> g_transforms = {
		...
		{"AxisAngle", "rotate", 2, matrixInput, 1, matrixInput, NO_TAG, AngleAxisInputNames},       // rotate
		{"Quat", "quat", 2, matrixInput, 1, matrixInput, NO_TAG, AngleAxisInputNames},                      // quat rotate
		{"Ortho", "ortho", 6, matrixInput, 1, matrixInput, NO_TAG, orthoFrustrumInputNames},            // ortho
		{"Perspective", "perspective", 4, matrixInput, 1, matrixInput, NO_TAG, PerspectiveInputNamas}, // perspective
		{"Frustum", "frustum", 6, matrixInput, 1, matrixInput, NO_TAG, orthoFrustrumInputNames},        // frustrum
		{"LookAt", "lookAt", 3, matrixInput, 1, matrixInput, NO_TAG, lookAtInputNames},             // lookAt
};
