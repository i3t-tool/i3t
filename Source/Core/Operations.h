...
struct Operation {
	...
	const std::vector<std::string> defaultOutputNames = DEFAULT_NAMES;	// if the names are not the names of the OpValueType
};
...
static const std::vector<OpValueType::type> threeFloatInput = { OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT };
static const std::vector<OpValueType::type> threeVector3Input = { OpValueType::VEC3, OpValueType::VEC3, OpValueType::VEC3 };


static const std::vector<OpValueType::type> fourVectorInput = { OpValueType::VEC4, OpValueType::VEC4 , OpValueType::VEC4, OpValueType::VEC4 };
static const std::vector<OpValueType::type> fourVector3Input = { OpValueType::VEC3, OpValueType::VEC3 , OpValueType::VEC3, OpValueType::VEC3 };
static const std::vector<OpValueType::type> fourFloatInput = { OpValueType::FLOAT, OpValueType::FLOAT , OpValueType::FLOAT, OpValueType::FLOAT };

static const std::vector<OpValueType::type> sixFloatInput = { OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT,
													OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT
};

static const std::vector<OpValueType::type> sixteenFloatInput = { OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT,
														OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT,
														OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT,
														OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::FLOAT
};

static const std::vector<OpValueType::type> twoVectorFloatInput = { OpValueType::VEC4, OpValueType::VEC4, OpValueType::FLOAT };
static const std::vector<OpValueType::type> twoVector3FloatInput = { OpValueType::VEC3, OpValueType::VEC3, OpValueType::FLOAT };
static const std::vector<OpValueType::type> twoFloatVector3Input = { OpValueType::FLOAT, OpValueType::FLOAT, OpValueType::VEC3 };
static const std::vector<OpValueType::type> twoQuatFloatInput = { OpValueType::QUAT, OpValueType::QUAT, OpValueType::FLOAT };
...
static const std::vector<Operation> operations = {
	...
	{"VectorMulMatrix","vec4 * mat",2, vectorMatrixInput, 1, vectorInput},		// vec4 * mat	MN jaky je duvod teto operace a nema byt vysledek matice???
	...
	{"ShowVector3","show vec3",1, vector3Input, 1, matrixInput, "Create the matrix transforming vector [1, 0, 0] to the input vector. Should be used with bind objects / basic / vectors."},			// show vec3
	...
	{"AngleAxisToQuat","quatangle, axis",3, twoFloatVector3Input, 1, quatInput, NO_TAG, AngleAxisToQuatInputNames},	// quatangle, axis
	{"VecVecToQuat","quatvec3, vec3",3, twoVector3Input, 1, floatInput, "Input vector's are normalized."},		// quatvec3, vec3
	{"QuatToFloatVec","quat -> float, vec3",1, quatInput, 2, floatVector3Input, NO_TAG,  DEFAULT_NAMES, QuatToFloatVecInputNames},		// quat -> float, vec3 
	{"QuatToAngleAxis","quat -> angle, axis",1, quatInput, 2,  floatVector3Input, NO_TAG,  DEFAULT_NAMES, AngleAxisInputNames},		// quat -> angle, axis
	...
	{"ClampFloat","clamp float",3, threeFloatInput, 1, floatInput, "Clamp val to <min, max> interval.\n Default min = 0 and max = 1", ClampFloatInputNames},		// clamp float
	...
	{"Vectors3ToMatrix","vecs3 -> mat",4, fourVector3Input, 1, matrixInput, NO_TAG, Vectors3ToMatrixInputNames},	// vecs3 -> mat
	{"VectorsToMatrix","vecs4 -> mat",4, fourVectorInput, 1, matrixInput, NO_TAG, VectorsToMatrixInputNames},		// vecs4 -> mat
	{"MatrixToFloats","mat -> floats",1, matrixInput, 16, sixteenFloatInput, NO_TAG, DEFAULT_NAMES, matrixIndexNames()},	// mat -> floats
	{"FloatsToMatrix","floats -> mat",16, sixteenFloatInput, 1, matrixInput, NO_TAG, matrixIndexNames()},	// floats -> mat
	...
	{"VectorToFloats","vec4 -> floats",1, vectorInput, 4, fourFloatInput, NO_TAG, DEFAULT_NAMES, xyzw},		// vec4 -> float
	{"FloatsToVector","floats -> vec4",4, fourFloatInput, 1, vectorInput, NO_TAG, xyzw},		// floats -> vec4
	{"Vector3ToFloats","vec3 -> floats",1, vector3Input, 3, threeFloatInput, NO_TAG, DEFAULT_NAMES, xyz},		// vec3 -> floats
	...
	{"QuatToFloats","quat -> floats",1, quatInput, 4, fourFloatInput, NO_TAG, DEFAULT_NAMES, xyzw},			// quat -> floats
