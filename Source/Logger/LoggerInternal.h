...
#define LOG_EVENT_MOUSE_POS(mouseX, mouseY)                                                                            \
	Logger::getInstance().log(LoggingOption::MOUSE_MOVEMENT, Logger::getInstance().getLogString("mousePos"), 2, mouseX,  \
	                          mouseY)
#define LOG_EVENT_MOUSE_CLICK(button, mouseX, mouseY)                                                                  \
	Logger::getInstance().log(LoggingOption::MOUSE_CLICK, Logger::getInstance().getLogString("mouseClick"), 3, button,   \
	                          mouseX, mouseY)
#define LOG_EVENT_MOUSE_RELEASE(button, mouseX, mouseY)                                                                \
	Logger::getInstance().log(LoggingOption::MOUSE_CLICK, Logger::getInstance().getLogString("mouseRelease"), 3, button, \
	                          mouseX, mouseY)
...
#define LOG_EVENT_CONNECT(startTab, endTab)                                                                            \
	Logger::getInstance().log(LoggingOption::LOGIC, Logger::getInstance().getLogString("connect"), 2,                    \
	                          startTab->getNameableParentNameId(), endTab->getNameableParentNameId())
#define LOG_EVENT_DISCONNECT(startTab, endTab)                                                                         \
	Logger::getInstance().log(LoggingOption::LOGIC, Logger::getInstance().getLogString("disconnect"), 2,                 \
	                          startTab->getNameableParentNameId(), endTab->getNameableParentNameId())
...
#define LOG_EVENT_TUTORIAL_STEP(tutorial, step, name)                                                                  \
	Logger::getInstance().log(LoggingOption::TUTORIAL, Logger::getInstance().getLogString("tutorial"), 3, tutorial,      \
	                          step, name)
...
private:
	...
	void vAddToLogBuffer(const LoggingOption& logType, const std::string& message, const int numOfArgs,
	                     va_list& arguments);
