...
void scalar(struct ParseState* parser, struct Value* returnValue, struct Value** param, int numArgs)
{
	...
	if (datavalid) { ValueSetResult result = node->getNodebase()->setValue(mat[0][0]); }
...
void saveW(struct ParseState* parser, struct Value* returnValue, struct Value** param, int numArgs)
{
	...
	auto        ww       = I3T::getWindowPtr<WorkspaceWindow>();
	bool        status   = false;
	if (ww != nullptr) { status = saveWorkspace(filename.c_str(), &ww->getNodeEditor().m_workspaceCoreNodes); }
	returnValue->Val->Integer = status;
}
...
struct LibraryFunction platformLibraryI3T[] = {
    ...
    {dataMat4,
     "int datamat4(float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float);"},
...
void platformLibraryInitI3T(Picoc* pc)
{
	...
	VariableDefinePlatformVar(pc, nullptr, "scale", &pc->IntType, (union AnyValue*) &scriptingData.mat4Types.scale,
	                          false);
	...
	VariableDefinePlatformVar(pc, nullptr, "translate", &pc->IntType,
	                          (union AnyValue*) &scriptingData.mat4Types.translate, false);
	VariableDefinePlatformVar(pc, nullptr, "axisangle", &pc->IntType,
	                          (union AnyValue*) &scriptingData.mat4Types.axisangle, false);
	VariableDefinePlatformVar(pc, nullptr, "ortho", &pc->IntType, (union AnyValue*) &scriptingData.mat4Types.ortho,
	                          false);
	...
	VariableDefinePlatformVar(pc, nullptr, "trackball", &pc->IntType,
	                          (union AnyValue*) &scriptingData.mat4Types.trackball, false);
	VariableDefinePlatformVar(pc, nullptr, "transpose", &pc->IntType,
	                          (union AnyValue*) &scriptingData.mat4Types.transpose, false);
	VariableDefinePlatformVar(pc, nullptr, "matmulvec", &pc->IntType,
	                          (union AnyValue*) &scriptingData.mat4Types.matmulvec, false);
	VariableDefinePlatformVar(pc, nullptr, "vecmulmat", &pc->IntType,
	                          (union AnyValue*) &scriptingData.mat4Types.vecmulmat, false);
	...
	VariableDefinePlatformVar(pc, nullptr, "mul", &pc->IntType, (union AnyValue*) &scriptingData.arithmeticOperators.mul,
	                          false);
	VariableDefinePlatformVar(pc, nullptr, "show", &pc->IntType,
	...
	VariableDefinePlatformVar(pc, nullptr, "norm", &pc->IntType,
	...
	VariableDefinePlatformVar(pc, nullptr, "qvq", &pc->IntType, (union AnyValue*) &scriptingData.quatOperators.qvq,
	                          false);
	//node lod
	...
	//cam add modes
	VariableDefinePlatformVar(pc, nullptr, "proj", &pc->IntType, (union AnyValue*) &scriptingData.camAddModes.proj,
	                          false);
	VariableDefinePlatformVar(pc, nullptr, "view", &pc->IntType, (union AnyValue*) &scriptingData.camAddModes.view,
	                          false);
}
