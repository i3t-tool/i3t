...
Link::Link(DIWNE::Diwne& diwne, DIWNE::ID id,
    ...
    : DiwneObject(diwne, id, labelDiwne),
      m_startDiwne(
          ImVec2(0, 0)) /* only initialize value - see initializeDiwne() */
      ,
...
void Link::updateSquareDistanceMouseFromLink()
{
	...
	ImVec2 closestPointOnLink = ImBezierCubicClosestPointCasteljau(
	    m_startDiwne, m_controlPointStartDiwne, m_controlPointEndDiwne,
	    m_endDiwne, mousePosDiwne, ImGui::GetStyle().CurveTessellationTol);
...
{
	m_controlPointStartDiwne =
	    m_startDiwne + diwne.mp_settingsDiwne->linkStartControlOffsetDiwne;
	m_controlPointEndDiwne =
	    m_endDiwne + diwne.mp_settingsDiwne->linkEndControlOffsetDiwne;
}
...
bool Link::processFocused()
{
	...
	diwne.AddBezierCurveDiwne(
	    m_startDiwne, m_controlPointStartDiwne, m_controlPointEndDiwne,
	    m_endDiwne, diwne.mp_settingsDiwne->objectFocusBorderColor,
...
bool Link::processFocusedForInteraction()
{
	diwne.AddBezierCurveDiwne(
	    m_startDiwne, m_controlPointStartDiwne, m_controlPointEndDiwne,
	    m_endDiwne, diwne.mp_settingsDiwne->objectFocusForInteractionBorderColor,
...
bool Link::content()
{
	...
	diwne.AddBezierCurveDiwne(m_startDiwne, m_controlPointStartDiwne,
	                          m_controlPointEndDiwne, m_endDiwne,
