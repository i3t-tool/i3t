...
public:                             /* \todo JH some atributes should be private/protected */
	...
	bool              m_inner_interaction_happen,
	    m_inner_interaction_happen_previous_draw; /*!< If some interaction happen with inner elements (DragFloat, Button, ...) it block interaction with this object */
	DrawMode m_drawMode; /*!< \see enum DrawMode */
	bool     m_selectable;
	bool     m_isHeld /*!< Is object held. When dragged it is still held. */, m_isDraged /*!< Is object draged */,
	    m_selected /*!< Is object selected */,
	    m_focusedForInteraction /*!< Is object focus on area that allow interaction with object */,
	    m_focused /*!< Is object focused anywhere (and for example can not be focus other underlying object) */,
	...
	virtual bool
	             processInteractionsAlways(); /*!< processes that happen even in allowInteraction() return false, but object still has to be in DrawMode::Interaction */
	...
	virtual bool
	bypassFocusAction(); /*!< action identified as focusing on object (and prevent underlying object from focusing) */
	virtual bool
	             bypassFocusForInteractionAction(); /*!< action identified as focusing on object for interacting with it */
	...
	virtual bool
	bypassTouchAction(); /*!< action used for touching object - not interact with it, just move it to front of other objects */
