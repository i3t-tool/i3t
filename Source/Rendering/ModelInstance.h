...
public:
  ...
  ModelInstance(Geometry* _geometry, Material* _material) : geometry(_geometry), material(_material), alphaFlag(false),
                                                            visible(true)
  {
  }
   ...
   */
  void setAlphaFlag(const bool val)
  {
    alphaFlag = val;
  }

  bool getAlphaFlag() const
  {
    return alphaFlag;
  }
