...
/*struct pgr::MeshData {
  ...
  unsigned nAttribsPerVertex; ///< all built-in have 8 -> 3 position, 3 normal,
2 texCoord

  const float* verticesInterleaved; ///< vertex data for each vertex 3pos, 3nor,
2tex const unsigned* triangles; ///< for each triangle 3 indices to the vertex
array
};*/
