 ...
 * This class keeps global record of Components and m_stencil values registered
 * by them, which allows to use globally unique m_stencil values and find
 * Component instance binded to int. This is used for selecting objects in 3D
 * scene.
 */
//---------------
#include "Component.h"
...
{
public:
	static bool stencilRef[256]; ///< table of registred stencil values. true -
