...
private:
	...
	int m_editaxis = 0;
	GameObject *m_circleh, *m_arrowh, *m_planeh, *m_scaleh, *m_uniscaleh,
	    *m_lineh;
	char m_stencilx, m_stencily, m_stencilz, m_stencilzx, m_stencilzy,
	    m_stencilyx, stencilxyz, m_stencilaxisx, m_stencilaxisy, m_stencilaxisz,
	    m_stencilaxisw;
	int m_activehandle = -1, m_hoverhandle = -1, m_axisnum = -1, m_axisnum2 = -1;
	glm::mat4 m_edited = glm::mat4(1.0f);
	glm::mat4 m_handlespace =
	    glm::mat4(1.0f); ///< transformation of handles - position+rotation -
