...
void ScaleManipulator::update()
{
	...
	{ // if uniform scale, scale of other axes proportionate to ref axis
		...
		{ // if no ref axis found, then no changes to drag vector needed - the axis
			// is x,x,x as default which is proportionate to scale by 0,0,0
		}
	}
	...
	///
	// if(m_editednode!=nullptr){ValueSetResult
