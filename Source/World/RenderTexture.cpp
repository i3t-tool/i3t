...
// TODO PF - This object is used for a given size of the texture. Create a resize function for screen!
...
void RenderTexture::resize(int newWidth, int newHeight)
{
	...
	if (newWidth != m_width || newHeight != m_height)
	{
		...
		//if( rateX < MIN_RATE || rateX > MAX_RATE || rateY < MIN_RATE || rateY > MAX_RATE)   // both directions
